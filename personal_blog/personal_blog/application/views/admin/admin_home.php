            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                  ...
                  <a href="<?php echo base_url();?>super_admin"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
                    ...
                    <li>
                 <a href="<?php echo base_url();?>super_admin/add_category"><i class="fa fa-bar-chart-o fa-fw"></i><span class="fa arrow"></span>Add Category</a>
               
                        <!-- second-level-items -->
                    </li>
                     <li>
 <a href="<?php echo base_url();?>super_admin/manage_category"><i class="fa fa-flask fa-fw"></i>Manage Category</a>
                    </li>
                    <li>
       <a href="<?php echo base_url();?>super_admin/add_post"><i class="fa fa-table fa-fw"></i>Add Post</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>super_admin/manage_post"><i class="fa fa-edit fa-fw"></i>Manage Post</a>
                    </li>
                    <li>
